      ...
      var logic = {
        size: {
          small: function($html){
            ...
            containerWidth = (stepCount*65+defineWidth)+"px",
          ...
          large: function($html){
            var stepCount = $html.find("li").length-1,
            containerWidth = (stepCount*defineWidth+defineWidth)+"px",
            progressWidth = (stepCount*defineWidth)+"px";
            $html.css({
              width: containerWidth
            });
            $html.find(".ystep-progress").css({
    ...
    setStep: function(step) {
      $(this).each(function(i,n){
        ...
        if(1<=step && step<=$steps.length){
          //更新进度
          var scale = "%";
          scale = Math.round((step-1)*defineWidth/($steps.length-1))+scale;
          $progress.animate({
            width: scale
          },{
            speed: 1000,
