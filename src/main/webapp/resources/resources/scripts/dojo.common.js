...
w.errorMsg = null;
var recurrenceFlag = !1, exceptionLog = function (a) {
...
$.extend({
    ...
    ajaxGetJson: function (a, b, c, d, e) {
        $.ajax({
            url: a, data: b, type: "get", async: 0 == (d | !1) ? !1 : !0, beforeSend: function () {
                $.loadingShow(e)
            }, complete: function () {
                $.loadingHide(e)
            }, dataType: "json", contentType: "application/json; charset=utf-8", success: function (a) {
                $.ajaxSuccess(a, c)
    ...
    ajaxPostJson: function (a, b, c, d, e) {
        $.ajax({
            url: a, data: b, type: "post", async: 0 == (d | !1) ? !1 : !0, beforeSend: function () {
                $.loadingShow(e)
            }, complete: function () {
                $.loadingHide(e)
            }, dataType: "json", contentType: "application/json;charset=utf-8", success: function (a) {
    ...
    ajaxPostText: function (a, b, c, d) {
        $.ajax({
            url: a, data: b, type: "post", dataType: "text", beforeSend: function () {
                $.loadingShow(d)
            }, complete: function () {
                $.loadingHide(d)
            }, contentType: "text;charset=utf-8", success: function (a) {
                $.ajaxSuccess(a, c)
            }, error: function (a, b, c) {
                exceptionLog("Ajax post error : " + a + "---" + b + "---" + c)
            }
    ...
    dateDiff: function (a, b, c) {
        var d = {D: 864e5, H: 36e5, M: 6e4, S: 1e3, T: 1};
        a = a.toUpperCase();
        try {
    ...
    showError: function (a, b) {
        ...
        $.each(b, function (a, b) {
            d += b.message + "\n"
        }), d && $.showMsg({msgType: $.dmxMsgType.Alert, msgText: d, focusElement: $(b[0].element)})
    },
