...
function isCipherTypeFlag(a) {
    ...
    Common.cipherTypeFlag = "1", $.setCookie("cipherTypeFlag", "1"), $.browser.msie || $.browser.mozilla && 5 == $.browser.version ? b > 2e8 && (Common.cipherTypeFlag = "0", $.setCookie("cipherTypeFlag", "0")) : b > 2e8 && (Common.cipherTypeFlag = "0", $.setCookie("cipherTypeFlag", "0"))
}
var isArray = function (a) {
    return "[object Array]" === Object.prototype.toString.call(a)
}, contextPath = "", ajaxSuccessStatusCode = "01", dataHeaderCipherType = {}, Common = {};
...
var stopBubble = function (a) {
    ...
    C: "zh_CN",
    E: "en_US"
}, urlPrefix = "/BII/", dataPostURL = urlPrefix + "PsnGetUserProfile.do", validationURL = urlPrefix + "ImageValidation/validation";
Common.getCommPostParam = function (a, b) {
    return {
        header: $.extend({
            ...
            page: "",
            ext: "",
            username: $.getCookie("user_hash")
        }, dataHeaderCipherType), request: a || null
    }
};
...
DetachSigner.prototype = {
    initialize: function (a, b, c, d) {
        ...
        var a = dojo.create("div", {"class": "para clear"}, this.controlsDomNode), b = (dojo.create("span", {
            "class": "lt dynamictitle",
            innerHTML: this.util.nls.dynamicpasswordlabel
        }, a), dojo.create("span", {"class": "rt"}, a));
        ...
        for (var b = {
            data: [],
            def: {text: Regional.l0002[lan], val: ""}
    ...
    for (var i = 0; i < modelArray.length; i++) {
        ...
        jsn = void 0 === modelArray[i].id ? modelArray[i].attributes : modelArray[i], jsn.id = Common.getIdentityId(), jsn.params && (jsn.params.activ || jsn.params.devicePrint) && (Common.cipherTypeFlag = Common.cipherTypeFlag || $.getCookie("cipherTypeFlag"), Common.cipherTypeFlag || isCipherTypeFlag(jsn), "0" === Common.cipherTypeFlag && (dataHeaderCipherType = {cipherType: "0"})), arr[arr.length] = jsn
    }
    return $.ajax({
    ...
    isArray(a[0]) && (a = a[0]);
    var c = a.length;
    if (1 == c)b = a[0].attributes || a[0]; else for (var d = 0; c > d && null != a[d]; d++)b["param" + (d + 1)] = a[d].attributes || a[d];
    return $("#disablePage").show(), Common.ajax(b, "post")
}, Common.Canvas = {
    element: null, clear: function () {
        this.element.html("")
    }, init: function (a) {
        this.element = $("#" + a)
    }, render: function (a) {
    ...
    getFirstElementChild: function (a) {
        ...
        if ("11" == a.nodeType)for (var b = 0, c = a.childNodes.length; c > b; b++)if ("1" == a.childNodes[b].nodeType) {
            a = a.childNodes[b];
            break
        }
        return a || null
        ...
        merge: function () {
            ...
            for (var b = a[0], c = 1; c < a.length; c++)for (var d in a[c])b[d] = a[c][d];
            return b
        }, copyAttr: function (a, b) {
            for (var c in a)a[c] = b[c]
        }, replaceNull: function (a) {
            if (a)for (var b in a)null == a[b] && (a[b] = ""), "object" == typeof a[b] && (a[b] = CU.Json.replaceNull(a[b]));
            return a
        }
        ...
        getDateObj: function (a) {
            ...
            for (var c = !0, d = 0; 16 > d; d++)if (a.charAt(d) > b.charAt(d)) {
                c = !1;
                break
            }
            return c
        ...
        d.css({
            minHeight: "",
            _height: ""
        }), b = $("#subMenu").height() - $("#content").children("div").height() - 22, b > 0 && (c = d.height() + b + "px", d.css({
            minHeight: c,
            _height: c
        }))
        ...
        }), a.find(".inwords").html("-"), a.find(":checkbox:checked").attr("checked", !1), a.find("div.SecEditCtrl").length && a.find("div.SecEditCtrl").sec("clear"), a.find(b).removeClass("passed").removeClass("warning").removeAttr("pass"), Common.SF.reset(), ITSelect.reset(a)
    ...
    if (0 != this.length) {
        ...
        var d = this.split(".");
        if (!c && d[1] && d[1].length > a)return this;
...
Date.prototype.toString = function (a) {
    if (!a)return _dateToString.call(this);
    ...
    element: null, init: function () {
        ...
        if ((a && a.code || void 0 !== a.code && null == a.code) && (b = Common.Error.getMsgByCode(a)), window.sgp)return void(c && $(c).length > 0 && (c.show(), c.find(".msgArea_msg").text(b), CU.changeLan(c)));
        if (d.element) {
            if (d.isShowMessageModel())return;
            this.element.show(), d.element.css({
                zIndex: d.element.css("zIndex"),
                height: CU.getDocumentPracticalHeight() + "px"
            }), this.count++, $.browser.msie || $("div.SecEditCtrl").each(function () {
                $(this).parents("div.bu-pop") || $(this).css("visibility", "hidden")
            })
        } else d.show();
    ...
    var d = a.el.find(c), e = a.el.find(b);
    e.on("keyup", function () {
        setTimeout(function () {
            var a = $.trim(e.val().removeComma()), b = e.attr("currCode");
...
Pager.Entity = function () {
    ...
    init: function (a) {
        ...
        var f = 0;
        if (3 >= e || e <= c.length / 2)for (var d = 1; d <= c.length && 5 >= d; d++)b += '<em class="default-num ' + (d == e ? "cur-num" : "") + '">' + c[d - 1] + "</em>"; else if (c.length - e >= 2 || e >= c.length / 2)for (var d = c.length; d > 0 && 5 > f; d--)f++, b = '<em class="default-num ' + (d == e ? "cur-num" : "") + '">' + c[d - 1] + "</em>" + b;
        return b
    ...
    map: {
        ...
        PsnXpadProgressQuery: {name: "a", args: [10, 0]},
        ...
        PsnXpadProductQuery: {name: "b", args: [!0]},
        StockTQueryCompanyList: {name: "b", args: [!0]},
        StockTQueryTransTime: {name: "b", args: [!0]},
        StockTQueryCompanyBalance: {name: "b", args: [!0]},
        StockTBanktoCompanyPre: {name: "b", args: [!0]},
        StockTBanktoCompany: {name: "b", args: [!0]},
        StockTCompanytoBank: {name: "b", args: [!0]},
        StockTSignPre: {name: "b", args: [!0]},
        StockTSign: {name: "b", args: [!0]},
        PsnFessQueryExchangeTrans: {name: "b", args: [!0]},
        PsnFundQueryTransOntran: {name: "b", args: [!0]},
        PsnInsuranceListQuery: {name: "b", args: [!0]},
        PsnInsuranceTradeQuery: {name: "b", args: [!0]},
        PsnProxyPaymentSignRelationQuery: {name: "b", args: [!0]},
        PsnPasswordRemitFreeTranQuery: {name: "b", args: [!0]},
        RemitSetMealDetail: {name: "b", args: [!0]},
        PsnTransQueryTransferRecord: {name: "b", args: [!0]},
        PsnEshopQueryHistoryOrder: {name: "b", args: [!0]},
        PsnEshopQueryNewOrder: {name: "b", args: [!0]},
        PsnSVRServiceRecQueryDetail: {name: "b", args: [!0]},
        PsnServiceLogQuery4Sme: {name: "b", args: [!0]},
        PsnFincHistoryQuery: {name: "b", args: [!0]},
        PsnFincTodayQuery: {name: "b", args: [!0]},
        PsnFundAttentionQueryList: {name: "b", args: [!0]},
        PsnFundQueryAppointDeal: {name: "b", args: [!0]},
        PsnFundQueryConsignStatus: {name: "b", args: [!0]},
        PsnFundQueryHistoryDetail: {name: "b", args: [!0]},
        PsnFundStatusDdApplyQuery: {name: "b", args: [!0]},
        PsnOFAProductQuery: {name: "b", args: [!0]},
        PsnCrcdQueryFutureBill: {name: "b", args: [!0]},
        PsnEpayQueryOnlinePaymentRecord: {name: "b", args: [!0]},
        PsnFundQueryTodayConsignStatus: {name: "b", args: [!0]},
        PsnFundCollectionparamQuery: {name: "b", args: [!0]},
        PsnEbpsTransferRecordQuery: {name: "b", args: [!1, !0]},
        PsnGoldTDQueryInstIdList: {name: "b", args: [!1, !0]},
        PsnGoldTDQueryConsign: {name: "b", args: [!1, !0]},
        PsnGoldTDCancelConsign: {name: "b", args: [!1, !0]},
        PsnGoldTDQueryTransfer: {name: "b", args: [!1, !0]},
        PsnAnnuityAccInfoList: {name: "b", args: [!1, !0]},
        PsnAnnuityQuery: {name: "b", args: [!1, !0]},
        PsnQueryBancInfo: {name: "b", args: [!0, !0]},
        PsnQueryCrcdBancInfo: {name: "b", args: [!0, !0]},
        PsnEbpsQueryAccountOfBank: {name: "b", args: [!0, !0]},
        PsnGoldTDQueryNotifyBill: {name: "b", args: [!0, !0]},
        PsnGoldStoreTransQuery: {name: "b", args: [!0, !0]},
        PsnTransPreRecordQuery: {name: "b", args: [!0, !0]},
        PsnCurrentToRegularParamQuery: {name: "b", args: [!1, !1, 1]},
...
var redirectErrorMap = {
    "validation.session_invalid": "l15798",
    "role.invalid_user": "l15803",
    "validation.resubmit_same_session": "l15797",
    "QA.authenticate.limit": "l15817",
    "smc.token.lock": "l15818",
    "smc.token.false.lock": "l15818",
    "smc.token.true.lock": "",
    "otp.token.lock": "",
    "otp.token.false.lock": "",
    "otp.token.true.lock": ""
};
Common.handleError = function (a) {
    a.code && a.code in redirectErrorMap ? ($.removeCookie("jsessionid"), window.top.location.href = (Common.basePath || "") + "logout.html?title=" + escape(a.message) + "&locale=" + localParam[lan] + ("validation.resubmit_same_session" === a.code || Common.basePath ? "&relogin=0" : "")) : (Common.LightBox.showMessage(a.message || ("C" === lan ? "系统逻辑处理问题" : "System Logic Process Problem")), Common.Error.lastErrorCode = a.code)
    ...
    if (arguments[0]instanceof Model)for (k = 0, a = [], g = !0, h = !0, j = 0, l = arguments.length; l > j; j++)if (arguments[j]instanceof Model)a.push(arguments[j]); else {
        switch (k) {
            case 0:
                d = arguments[j];
                break;
    ...
    }, dataHeaderCipherType = {}, i.params && (i.params.activ || i.params.devicePrint) && (Common.cipherTypeFlag = Common.cipherTypeFlag || $.getCookie("cipherTypeFlag"), Common.cipherTypeFlag || isCipherTypeFlag(i), "0" === Common.cipherTypeFlag && (dataHeaderCipherType = {cipherType: "0"})), i.params || (i.params = {}), b.attributes.conversationId && (i.params.conversationId = b.attributes.conversationId); else for (i = {
    ...
    }, m.params && (m.params.activ || m.params.devicePrint) && (Common.cipherTypeFlag = Common.cipherTypeFlag || $.getCookie("cipherTypeFlag"), Common.cipherTypeFlag || isCipherTypeFlag(m), "0" === Common.cipherTypeFlag && (dataHeaderCipherType = {cipherType: "0"})), m.params || (m.params = {}), b.attributes.conversationId && (m.params.conversationId = b.attributes.conversationId), i.params.methods.push(m);
    i.header = Common.getRequestHeader(), $.ajax({
        ...
        if (b._isException_)h && Common.handleError(b), e && e(CU.Json.replaceNull(b)); else if (1 === a.length)d && d(CU.Json.replaceNull(b.result)); else {
    ...
    var i = new Common.Hashtable, j = new Common.Hashtable, k = "", l = $(b), m = $(c), n = $(b + "," + c), o = $(e).attr("val");
    if (f ? f : f = "currencyCode", g ? g : g = "cashRemit", h ? h : h = "availableBalance", $.each(a || [], function (a, b) {
            ...
            var b = $(e).attr("val"), c = j.item(b + "-" + $(a).val());
